...
setup(
    ...
    url="https://github.com/shiftbreak/AWSAD2CLI",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="ShiftBreak",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="shiftbreak@password1.net",  # Optional
    ...
    keywords="iam, boto, aws",  # Optional
